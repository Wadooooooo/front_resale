...
function InspectionPage() {
    ...
    const handleSelectForChecklist = (phone) => { resetForm(); setSelectedPhone(phone); setSerialNumber(phone.serial_number || ''); setModelNumber(phone.model_number?.name || ''); const initialResults = {}; checklist.forEach(item => { initialResults[item.id] = { result: null, notes: '' }; }); setResults(initialResults); };
